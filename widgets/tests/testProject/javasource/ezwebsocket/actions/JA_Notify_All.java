 ...
 */
public class JA_Notify_All extends CustomJavaAction<java.lang.Boolean>
{
	...
	{
		// BEGIN USER CODE
		return WebsocketManager.notify(objectId, Collections.<system.proxies.User>emptyList(), action, message, websocketIdentifier);
		// END USER CODE
	}
